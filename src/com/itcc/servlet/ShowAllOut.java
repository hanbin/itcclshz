 ...
 * @author Icer
 */
public class ShowAllOut extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int pageNum = detailDao.getPageNum("1");
        int n = 0;//需要显示的页码
        ...
        list = detailDao.getData_out(n,username);
        System.out.println("showpage:"+showPage);
        System.out.println("pageNum:"+pageNum);
        request.setAttribute("showPage", new Integer(n));
        request.setAttribute("pageNum", new Integer(pageNum));
        /*
         String sql = "select *from detail_tb where inorout='1'";
         list = detailDao.search(sql);
         */
        
        System.out.println("list" + list);
        request.setAttribute("list", list);
        request.getRequestDispatcher("webpages/out/index.jsp").forward(request, response);
    }
